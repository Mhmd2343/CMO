...
namespace DeliveryAppSystem.Migrations
{
    ...
    [Migration("20250515174622_AddDriverAndClientToShopOrder")]
    partial class AddDriverAndClientToShopOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeliveryAppSystem.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("DeliveryAppSystem.Models.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeliveryAppSystem.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("DeliveryAppSystem.Models.Product", b =>
                {
                    b.HasOne("DeliveryAppSystem.Models.ProductCategory", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("DeliveryAppSystem.Models.ShoppingCartItem", b =>
                {
                    b.HasOne("DeliveryAppSystem.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("ShopOrder", b =>
                {
                    b.HasOne("DeliveryAppSystem.Models.Driver", "AssignedDriver")
                        .WithMany()
